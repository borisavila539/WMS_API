...
namespace Core.Interfaces
{
    public interface IWMSRepository
    {
        ...
        public Task<List<IM_WMS_Despacho_Tela_Detalle_Rollo>> GetDespacho_Tela_Picking_Packing(string INVENTSERIALID, string TIPO, string InventTransID,string USER, int IDRemision );
        ...
        public Task<List<IM_WMS_DetalleImpresionEtiquetasPrecio>> GetDetalleImpresionEtiquetasPrecio(ImpresionEtiqueta impresionEtiquetaParm);
        ...
        public Task<IM_WMS_UpdateDetalleDefectoDevolucion> getActualizarDetalleDefectoDevolucion(int id, int idDefecto, string tipo, bool Reparacion, int operacion,int qty);
        ...
        public Task<string> ImprimirEtiquetaRolloDenim(List<EtiquetaRolloDTO> data);
